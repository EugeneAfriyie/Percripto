  ...
  return (
    <div className='flex flex-col md:flex-row bg-primary rounded-lg px-6 md:px-10 lg:px-20  '>
        ...
        <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px] ">
            <p className='text-3xl md:text-4xl  xl:text-5xl text-white font-semibold leading-tight   '>
                Book Apointment <br /> with Trusted Doctors
            </p>
            <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
                <img className='w-28 ' src={assets.group_profiles} alt="" />
                <p>
                    Simply browse through our extensive list verified doctors <br className='hidden sm:block   ' /> and book your appointment in just a few clicks.
                </p>
            </div>
